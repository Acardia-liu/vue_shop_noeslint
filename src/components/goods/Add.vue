<template>
    <div>
        ...
        <el-card>
            ...
            <!--tab栏区域-->
            <!--label-position="top"label在输入框之上-->
            <el-form :model="addForm" status-icon :rules="addFormRules"
                ...
                <el-tabs v-model="activeIndex" :tab-position="'left'"
                    ...
                    <el-tab-pane label="商品参数" name="1">
                        ...
                        <el-form-item :label="item.attr_name" v-for="item in manyTableData"
                            ...
                            <el-checkbox-group v-model="item.attr_vals">
                                <el-checkbox :label="cb" v-for="(cb,index) in item.attr_vals"
                    ...
                    <el-tab-pane label="商品图片" name="3">
                        ...
                        <!--upload组件内部封装了Ajax，未调用axios,需要手动装配token-->
                        <el-upload
                                :action="uploadURL"
        ...
        methods: {
            ...
            add() {
                this.$refs.addFormRef.validate(async valid => {
                    ...
                    /*执行添加的业务逻辑*/
                    /*与级联选择器冲突，addForm要进行双向绑定，需进行深拷贝*/
                    ...
                    if(res.meta.status !== 201){
                        return this.$message.error("添加商品列表失败！")
                    }
